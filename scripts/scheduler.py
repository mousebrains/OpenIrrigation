...
class Scheduler(threading.Thread):
  ...
  def run(self): # Called on thread start
    ...
    while True:
      ...
      logger('msg now={} s={} e={}'.format(datetime.datetime.fromtimestamp(time.time()), sDate, eDate))
...
thrTrigger = Trigger(args, logger, thrSched.q) # Read scheduler table and trigger scheduler
thrTrigger.start()
