...
CREATE DOMAIN POSINTEGER AS INTEGER CHECK (VALUE IS NOT NULL AND VALUE>0);

DROP DOMAIN IF EXISTS NONNEGINTEGER CASCADE;
CREATE DOMAIN NONNEGINTEGER AS INTEGER CHECK (VALUE IS NOT NULL AND VALUE>=0);

DROP DOMAIN IF EXISTS POSFLOAT CASCADE;
CREATE DOMAIN POSFLOAT AS FLOAT CHECK (VALUE IS NOT NULL AND VALUE>0);

DROP DOMAIN IF EXISTS NONNEGFLOAT CASCADE;
CREATE DOMAIN NONNEGFLOAT AS FLOAT CHECK (VALUE IS NOT NULL AND VALUE>=0);
